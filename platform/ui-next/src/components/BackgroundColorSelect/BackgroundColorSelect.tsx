...
const BackgroundColorSelect: React.FC = () => {
  const [selectedColor, setSelectedColor] = useState('#0d1f14');
    ...
    <div>
      <Select onValueChange={handleColorChange}>
        ...
        <SelectContent>
          ...
          <SelectItem value="#0d1f14">Base</SelectItem>
          <SelectItem value="#0d1f14">Medium</SelectItem>
          <SelectItem value="#0d1f14">Header</SelectItem>
        </SelectContent>
      </Select>
    </div>
  );
