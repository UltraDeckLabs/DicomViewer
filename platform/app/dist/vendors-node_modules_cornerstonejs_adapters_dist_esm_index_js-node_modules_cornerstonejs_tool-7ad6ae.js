...
/* harmony import */ var _helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/compareArrays.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/compareArrays.js");
...
function getImageIdOfSourceImagebyGeometry(ReferencedSeriesInstanceUID, FrameOfReferenceUID, PerFrameFunctionalGroup, imageIds, metadataProvider, tolerance) {
  ...
  for (let imageIdsIndex = 0; imageIdsIndex < imageIds.length; ++imageIdsIndex) {
    ...
    if ((0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_2__["default"])(PerFrameFunctionalGroup.PlanePositionSequence[0].ImagePositionPatient, sourceImageMetadata.ImagePositionPatient, tolerance)) {
...
/* harmony import */ var _helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers/compareArrays.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/compareArrays.js");
...
function getImageIdOfSourceImagebyGeometry(ReferencedSeriesInstanceUID, FrameOfReferenceUID, PerFrameFunctionalGroup, imageIds, metadataProvider, tolerance) {
  ...
  for (let imageId of imageIds) {
    ...
    if (isMultiframe) {
      ...
      if (framePosition && (0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__["default"])(segFramePosition, framePosition, tolerance)) {
        return imageId;
      }
    } else if ((0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__["default"])(segFramePosition, sourceImageMetadata.ImagePositionPatient, tolerance)) {
      return imageId;
    }
  }
  return undefined;
...
function alignPixelDataWithSourceData(pixelData2D, iop, orientations, tolerance) {
  if ((0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__["default"])(iop, orientations[0], tolerance)) {
    return pixelData2D;
  } else if ((0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__["default"])(iop, orientations[1], tolerance)) {
    // Flipped vertically.

    // Undo Flip
    return flipMatrix2D.v(pixelData2D);
  } else if ((0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__["default"])(iop, orientations[2], tolerance)) {
    // Flipped horizontally.

    // Unfo flip
    return flipMatrix2D.h(pixelData2D);
  } else if ((0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__["default"])(iop, orientations[3], tolerance)) {
    //Rotated 90 degrees

    // Rotate back
    return rotateMatrix902D(pixelData2D);
  } else if ((0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__["default"])(iop, orientations[4], tolerance)) {
    //Rotated 90 degrees and fliped horizontally.

    // Undo flip and rotate back.
    return rotateMatrix902D(flipMatrix2D.h(pixelData2D));
  } else if ((0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__["default"])(iop, orientations[5], tolerance)) {
    // Rotated 90 degrees and fliped vertically

    // Unfo flip and rotate back.
    return rotateMatrix902D(flipMatrix2D.v(pixelData2D));
  } else if ((0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__["default"])(iop, orientations[6], tolerance)) {
    // Rotated 180 degrees. // TODO -> Do this more effeciently, there is a 1:1 mapping like 90 degree rotation.

    return rotateMatrix902D(rotateMatrix902D(pixelData2D));
  } else if ((0,_helpers_compareArrays_js__WEBPACK_IMPORTED_MODULE_4__["default"])(iop, orientations[7], tolerance)) {
    // Rotated 270 degrees
...
class Angle extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, imageToWorldCoords, metadata) {
    const {
      ...
      SCOORD3DGroup,
      ReferencedFrameNumber
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_1__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, Angle.toolType);
    if (SCOORDGroup) {
...
/* harmony import */ var _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./BaseAdapter3D.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/BaseAdapter3D.js");
/* harmony import */ var _CodingScheme_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./CodingScheme.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/CodingScheme.js");
...
const {
  codeValues
} = _CodingScheme_js__WEBPACK_IMPORTED_MODULE_3__["default"];
class ArrowAnnotate extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, imageToWorldCoords, metadata, _trackingIdentifier) {
    const {
      ...
      SCOORD3DGroup,
      ReferencedFrameNumber
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_0__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, ArrowAnnotate.toolType);
    const referencedImageId = defaultState.annotation.metadata.referencedImageId;
  ...
  static getTID300RepresentationArguments(tool, worldToImageCoords) {
    ...
    if (!finding || finding.CodeValue !== codeValues.CORNERSTONEFREETEXT) {
      finding = {
        ...
        CodingSchemeDesignator: _CodingScheme_js__WEBPACK_IMPORTED_MODULE_3__["default"].CodingSchemeDesignator,
...
const LONG_AXIS = "Long Axis";
const SHORT_AXIS = "Short Axis";
class Bidirectional extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_4__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, imageToWorldCoords, metadata) {
    const {
      defaultState,
      ReferencedFrameNumber
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_1__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, Bidirectional.toolType);
    const referencedImageId = defaultState.annotation.metadata.referencedImageId;
    const {
      ContentSequence
    } = MeasurementGroup;
    ...
    const longAxisSCOORDGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_2__.toArray)(longAxisNUMGroup.ContentSequence).find(group => group.ValueType === "SCOORD");
    const shortAxisSCOORDGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_2__.toArray)(shortAxisNUMGroup.ContentSequence).find(group => group.ValueType === "SCOORD");
  ...
  static getMeasurementDataFromScoord3d(_ref2) {
    ...
    const worldCoords = [];
    const longAxisSCOORD3DGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_2__.toArray)(longAxisNUMGroup.ContentSequence).find(group => group.ValueType === "SCOORD3D");
    const shortAxisSCOORD3DGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_2__.toArray)(shortAxisNUMGroup.ContentSequence).find(group => group.ValueType === "SCOORD3D");
...
class CircleROI extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, imageToWorldCoords, metadata) {
    const {
      ...
      SCOORD3DGroup,
      ReferencedFrameNumber
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_1__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, CircleROI.toolType);
    if (SCOORDGroup) {
      return this.getMeasurementDataFromScoord({
        defaultState,
        SCOORDGroup,
...
const EPSILON = 1e-4;
class EllipticalROI extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, imageToWorldCoords, metadata) {
    const {
      defaultState,
      NUMGroup,
      ...
      SCOORD3DGroup,
      ReferencedFrameNumber
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_2__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, EllipticalROI.toolType);
    if (SCOORDGroup) {
      return this.getMeasurementDataFromScoord({
        defaultState,
        SCOORDGroup,
  ...
  static getMeasurementDataFromScoord(_ref) {
    ...
    const columnCosinesVec = gl_matrix__WEBPACK_IMPORTED_MODULE_0__.vec3.fromValues(columnCosines[0], columnCosines[1], columnCosines[2]);
    const projectedMajorAxisOnColVec = gl_matrix__WEBPACK_IMPORTED_MODULE_0__.vec3.dot(columnCosinesVec, majorAxisVec);
    const projectedMinorAxisOnColVec = gl_matrix__WEBPACK_IMPORTED_MODULE_0__.vec3.dot(columnCosinesVec, minorAxisVec);
...
/* harmony import */ var _CodingScheme_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./CodingScheme.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/CodingScheme.js");
/* harmony import */ var _constants_index_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./constants/index.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/Cornerstone3D/constants/index.js");
...
class MeasurementReport {
  ...
  static getCornerstoneLabelFromDefaultState(defaultState) {
    ...
    const cornersoneFreeTextCodingValue = _CodingScheme_js__WEBPACK_IMPORTED_MODULE_8__["default"].codeValues.CORNERSTONEFREETEXT;
  ...
  static getSpatialCoordinatesState(_ref3) {
    ...
    const SCOORDGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_3__.toArray)(NUMGroup.ContentSequence).find(group => group.ValueType === "SCOORD");
    const SCOORD3DGroup = (0,_helpers_toArray_js__WEBPACK_IMPORTED_MODULE_3__.toArray)(NUMGroup.ContentSequence).find(group => group.ValueType === "SCOORD3D");
    if (SCOORDGroup) {
  ...
  static generateReferencedSOPSequence(_ref5) {
    ...
    const effectiveImageId = imageId === _constants_index_js__WEBPACK_IMPORTED_MODULE_9__.NO_IMAGE_ID ? this.getImageIdFromVolume({
      toolData,
      toolTypes
    }) : imageId;
  ...
  static generateReport(toolState, metadataProvider, worldToImageCoords, options) {
    ...
    Object.keys(toolState).forEach(imageId => {
      ...
      if (imageId === _constants_index_js__WEBPACK_IMPORTED_MODULE_9__.NO_IMAGE_ID) {
        is3DSR = true;
      }
      const measurementGroups = [];
      toolTypes.forEach(toolType => {
...
class PlanarFreehandROI extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, imageToWorldCoords, metadata) {
    const {
      ...
      SCOORD3DGroup,
      ReferencedFrameNumber
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_0__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, PlanarFreehandROI.toolType);
    if (SCOORDGroup) {
      return this.getMeasurementDataFromScoord({
        defaultState,
        SCOORDGroup,
...
class Probe extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, imageToWorldCoords, metadata, trackingIdentifier) {
    ...
    const {
      ...
      SCOORDGroup,
      SCOORD3DGroup
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_1__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, Probe.toolType);
    if (SCOORDGroup) {
      return this.getMeasurementDataFromScoord({
        state,
        defaultState,
...
class RectangleROI extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, imageToWorldCoords, metadata) {
    const {
      defaultState,
      NUMGroup,
      ...
      SCOORD3DGroup,
      ReferencedFrameNumber
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_1__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, RectangleROI.toolType);
    if (SCOORDGroup) {
      return this.getMeasurementDataFromScoord({
        defaultState,
        SCOORDGroup,
...
class UltrasoundDirectional extends _BaseAdapter3D_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  static getMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, imageToWorldCoords, metadata) {
    const {
      defaultState,
      SCOORDGroup,
      ReferencedFrameNumber
    } = _MeasurementReport_js__WEBPACK_IMPORTED_MODULE_1__["default"].getSetupMeasurementData(MeasurementGroup, sopInstanceUIDToImageIdMap, metadata, UltrasoundDirectional.toolType);
    const referencedImageId = defaultState.annotation.metadata.referencedImageId;
    const {
      GraphicData
    } = SCOORDGroup;
...
/* harmony import */ var _compareArrays_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./compareArrays.js */ "../../../node_modules/@cornerstonejs/adapters/dist/esm/adapters/helpers/compareArrays.js");
...
function checkOrientation(multiframe, validOrientations, sourceDataDimensions, tolerance) {
  ...
  const inPlane = validOrientations.some(operation => (0,_compareArrays_js__WEBPACK_IMPORTED_MODULE_1__["default"])(iop, operation, tolerance));
  if (inPlane) {
    return "Planar";
  }
